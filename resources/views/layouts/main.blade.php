...
<head>
    ...
    <title>Vendors Module | @yield('title')</title>
    ...
    <link href="{{ asset('/images/logos/kns.png') }}" rel="icon">
...
<body>
    <div
        class="app-container app-theme-white body-tabs-shadow {{ Auth::check() ? 'fixed-header fixed-sidebar' : '' }}">
        @if (!Auth::check())
                            ...
                            <div class="app-footer__inner">
                                ...
                                <div class="app-footer-right">
                                    <ul class="header-megamenu nav">
                                        <li class="nav-item">
                                            Product of <a class="text-danger" href="http://konvergenz.co.ke/"
                                                target="_blank">Konvergenz Network Solutions</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
